...
const VisualizationDashboard = lazy(() =>
  import("../analysis/VisualizationDashboard").then((module) => ({ default: module.VisualizationDashboard }))
);
const TimeSeriesWorkbench = lazy(() =>
  import("../analysis/TimeSeriesWorkbench").then((module) => ({ default: module.TimeSeriesWorkbench }))
);
